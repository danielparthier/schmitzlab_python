...
::: {.notes}
_ _ _ _ _ _ _
If your python terminal gets stuck at one point you can try do a `KeyboardInterrupt` using `Ctrl+C`, which will kill the running script.
:::
...
<!-- TODO add code examples which cause error and can be fixed -->
