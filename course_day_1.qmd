...
::: {.fragment}
![](img/requirements.jpg){.absolute top=120 left=400 width="350"}
:::
...
```{python}
new_dict["authors"]
new_dict["authors"].append('Daniel')
new_dict
```
:::
:::
...
::: {.fragment}
### <span style="position: absolute; left:-110px;"> README </span> 
<span style="position: relative; left:160px; font-size: 30px;"> - project documentation </span>
