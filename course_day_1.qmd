...
- This could mean single functions
...
- Or parts of a package (modules) which can be used with dot notation (`.`)

::: {.fragment}
``` {python }
from numpy import random
random.normal(size=2)
```
:::
...
- Also a part of a package can be loaded using `.`
